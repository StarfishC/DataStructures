...
>
> <div align=center><img src="./images/2-2-15.jpg" alt="2-2-15" height=300 width=80%/></div>
...
### 2.3.8 [教材习题 2.1.8](#218-已知两个依元素低增的有序排列的顺序表-a-和-b且同一表中的元素值各不相同构造一个线性表-c其元素为-a-和-b-中元素的交集且表-c-中的元素也依值有序递增排列设计对-abc-都是顺序表的情况的算法)
