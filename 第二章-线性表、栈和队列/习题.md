...
### 2.3.2 设$A=(a_1,...,a_m)$和$B=(b_1,..,b_n)$均为顺序表，A'和 B'分别是 A 和 B 中除去最大共同前缀后的子表。例如，A=(b,e,i,j,i,n,g)，B=(b,e,i,f,a,n,g)，则两者最大公共前缀为 b,e,i。此时 A'=(j,i,n,g)，B'=(f,a,n,g)。若 A'=B'=空表，则 A=B；若 A'=空表，而 B'≠ 空表，或者两者均不为空表，且 A'的首元小于 B'的首元，则 A<B；否则 A>B。试编写一个比较 A、B 大小的算法
...
> **解答：** _[code 2-3-7.cpp](./src/2-3-7.cpp)_
>
> ```cpp
>
> ```
...
> **解答：** _[code 2-3-8.cpp](./src/2-3-8.cpp)_
>
> ```cpp
>
> ```
...
> **解答：** _[code 2-3-10.cpp](./src/2-3-10.cpp)_
>
> ```cpp
> #include <stack>
> #include <iostream>
...
> **解答：** _[code 2-4-1.cpp](./src/2-4-1.cpp)_
>
> (1) 循环队列类型定义
>
> ```cpp
