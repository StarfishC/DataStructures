...
> **解答：** _[code 1-2-2.cpp](https://github.com/caoshenghui/DataStruct-zhangming/blob/master/%E7%AC%AC%E4%B8%80%E7%AB%A0-%E6%A6%82%E8%AE%BA/1-2-2.cpp)_
>
...
> **解答：** _[code 1-3-1.cpp](https://github.com/caoshenghui/DataStruct-zhangming/blob/master/%E7%AC%AC%E4%B8%80%E7%AB%A0-%E6%A6%82%E8%AE%BA/1-3-1.cpp)_
>
> 若整数过多可考虑使用排序算法
>
> ```cpp
...
> **解答：** _[code 1-3-2.cpp](https://github.com/caoshenghui/DataStruct-zhangming/blob/master/%E7%AC%AC%E4%B8%80%E7%AB%A0-%E6%A6%82%E8%AE%BA/1-3-2.cpp)_
>
...
> **解答：** _[code 1-3-3.cpp](https://github.com/caoshenghui/DataStruct-zhangming/blob/master/%E7%AC%AC%E4%B8%80%E7%AB%A0-%E6%A6%82%E8%AE%BA/1-3-3.cpp)_
>
> ```cpp
> #include <iostream>
> #include <climits>
...
> **解答：** _[code 1-3-4.cpp](https://github.com/caoshenghui/DataStruct-zhangming/blob/master/%E7%AC%AC%E4%B8%80%E7%AB%A0-%E6%A6%82%E8%AE%BA/1-3-4.cpp)_
>
> ```cpp
> #include <cmath>
>
...
> **解答：** _[code 1-3-5.cpp](https://github.com/caoshenghui/DataStruct-zhangming/blob/master/%E7%AC%AC%E4%B8%80%E7%AB%A0-%E6%A6%82%E8%AE%BA/1-3-5.cpp)_
>
> _部分代码如下：_
>
> ```cpp
...
>   所以有：  
>   $\Rightarrow f(n)=(0+1+...+(n-1))+(1+...+(n-1))+...+((n-2)+(n-1))$  
>   $\Rightarrow f(n)=1×0+2×1+3×2+...+(n-1)(n-2)+(n-1)(n-1)+(n-1)-(n-1)$  
>   $\Rightarrow f(n)=1×0+2×1+3×2+...+(n-1)(n-2)+n(n-1)-(n-1)$  
>   用裂项法求解，同乘 3 得：  
>   $\Rightarrow 3f(n)=1×2×3+2×3×3+...+(n-1)×n×3-3×(n-1)$  
>   $\Rightarrow 3f(n)=1×2×3+2×3×(4-1)+3×4×(5-2)...+(n-1)×n×[(n+1)-(n-2)]-3(n-1)$  
>   $\Rightarrow 3f(n)=1×2×3+2×3×4-1×2×3+3×4×5-2×3×4+...+(n-1)×n×(n+1)-(n-2)(n-1)n-3(n-1)$  
>   $\Rightarrow 3f(n)=(n-1)n(n+1)-3(n-1)$  
...
> f = \frac{n}{2} × (1+\frac{1}{2}+\frac{1}{3}+...+\frac{1}{2/n}) \\
> f = \frac{n}{2}(\ln{(\frac{n}{2}+1)}+C) =  \frac{n}{2}\ln{(\frac{n}{2}+1)}+\frac{nC}{2}
> $$
>
