...
> **解答:** > [code 1-2-2](https://github.com/caoshenghui/DataStruct-zhangming/blob/master/%E7%AC%AC%E4%B8%80%E7%AB%A0-%E6%A6%82%E8%AE%BA/1-2-2.cpp)  
...
> **解答：** > [code 1-3-1](https://github.com/caoshenghui/DataStruct-zhangming/blob/master/%E7%AC%AC%E4%B8%80%E7%AB%A0-%E6%A6%82%E8%AE%BA/1-3-1.cpp)  
> 若整数过多可考虑使用排序算法
>
> ```cpp
> #include <iostream>
...
### 1.3 设计一个算法，计算$i!*2^i$的值并存入数组 a[0..arrsize-1]的第$i-1$个分量中$(i=1,2,...,n)$。假设计算机允许的整数最大值为 maxint，则当$n>arrsize$或对某个$k(1\leqslant k\leqslant n)$，当$k!*2^i>maxint$时，按出错处理
...
> **解答：**[code 1-3-5](https://github.com/caoshenghui/DataStruct-zhangming/blob/master/%E7%AC%AC%E4%B8%80%E7%AB%A0-%E6%A6%82%E8%AE%BA/1-3-5.cpp)  
> _部分代码如下：_
>
> ```cpp
